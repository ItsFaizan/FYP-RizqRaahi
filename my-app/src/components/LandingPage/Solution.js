...
export const Solution = () => {
  return (
    ...
    <div className="w-full md:w-1/2">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 md:mt-80">
        <div className="bg-white p-4 ">
          <img src={green} alt='1'/>
          <h3 className="text-lg font-bold mt-2 mb-3">Feeding the Hungry</h3>
          <div className="w-16 h-1 bg-[#1ECF5A] ml-0 mb-2"></div>
          <p className="ml-0 leading-tight text-gray-600">We connect restaurants with NGOs, ensuring that surplus food reaches those who need it the most, one meal at a time.</p>
        </div>
        ...
        <div className="bg-white p-4 ">
          ...
          <div className="w-16 h-1 bg-[#1ECF5A] ml-0 mb-2"></div>
          <p className="ml-0 leading-tight text-gray-600">By diverting restaurant leftovers from landfills to the plates of the needy, we help reduce food wastage and its environmental impact.</p>
        </div>
        ...
        <div className="bg-white p-4 ">
          ...
          <div className="w-16 h-1 bg-[#1ECF5A] ml-0 mb-2"></div>
          <p className="ml-0 leading-tight text-gray-600">We forecast future donations <br/>from restaurants, helping NGOs<br/> plan and manage their food requirements effectively.</p>
        </div>
        ...
        <div className="bg-white p-4 ">
          ...
          <div className="w-16 h-1 bg-[#1ECF5A] ml-0 mb-2"></div>
          <p className="ml-0 leading-tight text-gray-600">Our app recommends the best restaurants based on the quality and quantity of food they provide.</p>
        </div>
      </div>
    </div>
  </div>
